...
export default function HistoryPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4 animate-fade-in">
      ...
      {/* Simple Header */}
      <div className="mb-12">
        <h1 className="text-3xl font-bold text-gray-900 font-bold">Historique de location</h1>
        <p className="text-gray-500 mt-1 font-medium">Consultez vos anciennes réservations et activités passées.</p>
      </div>
          ...
          {filteredHistory.map((res: any) => (
            <div key={res._id} className="bg-white rounded-xl border border-gray-100 soft-shadow overflow-hidden group hover:border-gray-200 transition-all">
              <div className="p-5 flex flex-col md:flex-row gap-6 md:items-center">
                 ...
                 <div className="w-full md:w-32 h-20 bg-gray-50 rounded-lg flex items-center justify-center p-2 border border-gray-50 shrink-0 opacity-60 group-hover:opacity-100 transition-opacity">
