  ...
  return (
    <footer className="bg-gray-900 text-white py-16 mt-20 w-full border-t border-white/5">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          <h4 className="text-xs font-black uppercase tracking-[0.2em] mb-6 text-gray-500">{t('links')}</h4>
          <ul className="space-y-3 text-sm text-gray-400">
            <li><Link href="/" className="hover:text-primary transition-colors">{navT('home')}</Link></li>
            <li><Link href="/cars" className="hover:text-primary transition-colors">{navT('cars')}</Link></li>
            <li><Link href="/dashboard" className="hover:text-primary transition-colors">{t('my_account')}</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-xs font-black uppercase tracking-[0.2em] mb-6 text-gray-500">{t('contact')}</h4>
        ...
        <div>
          <h4 className="text-xs font-black uppercase tracking-[0.2em] mb-6 text-gray-500">{t('newsletter')}</h4>
          <p className="text-gray-400 text-xs mb-4">{t('newsletter_desc')}</p>
      ...
      <div className="mt-16 text-center text-[10px] text-gray-600 border-t border-white/5 pt-8 font-bold uppercase tracking-widest">
        &copy; {new Date().getFullYear()} Carlaville Car Rental. {t('rights')}
      </div>
    </footer>
  );
}
